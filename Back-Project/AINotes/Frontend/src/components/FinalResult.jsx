  ...
  return (
    <div className='mt-6 p-3 space-y-10 bg-white'>
        ...
        <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
            <h2 className='text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent'>📒 Generated Notes</h2>

            <div className='flex gap-3'>
                <button onClick={()=>setQuickRevision(!quickRevision)} className={`px-4 py-2 rounded-lg text-sm font-medium transition ${quickRevision 
                ? "bg-green-600 text-white" 
                : "bg-green-100 text-green-700 hover:bg-green-200"} `}>{quickRevision ? "Exit Revision Mode" : "Quick Revision (5 min)"}</button>
                <button onClick={() =>downloadPdf(result)} className='px-4 py-2 rounded-lg text-sm font-medium bg-indigo-600 text-white hover:bg-indigo-700 cursor-pointer'>⬇️ Download PDF</button>
        ...
        {quickRevision && 
          <section className='rounded-xl bg-gradient-to-r from-gray-100 to-green-50 border border-green-200 p-6'>
            <h3 className='font-bold text-green-700 mb-3 text-lg'>⚡ Quick Exam Revision Points</h3>
          ...
          {result.diagram?.data && <section>
            ...
            <p className='mt-3 text-xs text-gray-500 italic'>ℹ️ If you need this diagram for future refrence or revision, you can save it by taking a screenshort. </p>
            </section>}
          ...
          <section>
            ...
            <p className='font-medium text-pink-500'>Long Questions:</p>
            <ul className="list-disc ml-6 text-gray-700">
            ...
            <p className='font-medium text-amber-500'>Diagram Questions:</p>
            <ul className="list-disc ml-6 text-gray-700">
