...
function Home() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black">
      ...
      {/* top  */}
      <section className="max-w-7xl mx-auto px-8 pt-28 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center ">
        <div>
          <motion.div
          ...
          >
            ...
            <motion.p
              whileHover={{ y: -2 }}
              className="mt-6 max-w-xl text-lg bg-gradient-to-br from-black/90 via-black/60 to-black/90 bg-clip-text text-transparent"
              style={{
                transform: "translateZ(40px)",
                textShadow: "0 18px 40px rgba(0,0,0,0.25)",
              }}
            >
              Generate exam-focused notes, projects documentation flow diagram
